...
export const metadata: Metadata = {
  ...
  description:
    "テキストやHTML、CSV、TSVなどを瞬時に.mdファイル（Markdown）へ変換してダウンロードできる無料ツールです。入力したデータは外部サーバーに送信されず、お使いの端末内だけで安全に処理されるため、社外秘データや個人情報でも情報漏洩の心配なく安心してお使いいただけます。会員登録・インストール不要です。",
  keywords: [
    "mdファイル変換",
    "Markdown",
    "マークダウン",
  ...
  openGraph: {
    title:
      "【登録不要・安全】mdファイル化ツール | テキストやCSVを一瞬で.mdにして保存",
    description:
      "テキストやHTML、CSV、TSVなどを瞬時に.mdファイルへ変換。データは外部サーバーに送信されず端末内で完結するため、情報漏洩の心配なく安全にダウンロードいただけます。",
